...
(function () {
    ...
    MaterialController.$inject = ['Authentication','Restangular', '$state', 'SweetAlert', '$stateParams'];

    function MaterialController(Authentication,Restangular, $state, SweetAlert, $stateParams) {
        var vm = this;
        vm.list = [];
        vm.save = save;
        vm.edit = edit;
        ...
        function save(form) {
            ...
            vm.material.UserId = Authentication.user.id;
            if (!vm.material.id) {
                Restangular.all('api/agent').post(vm.material).then(function (res) {
                ...
                Restangular.one('api/agent/' + vm.material.id).patch(vm.material).then(function (res) {
